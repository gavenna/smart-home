...
int thread_prevent_redefine_video = 0;
...
int main(int argc, char *argv[])
{
    ...
    // lcd_draw_REBOX(100, 100, 100, 80, 10, 0xac1232);
    // sleep(50);
    MENU_INIT();

    pthread_t tid_icon, tid_global_stop, tid_time, tid_effect, tid_music, tid_video;
